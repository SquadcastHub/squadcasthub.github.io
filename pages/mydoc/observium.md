...
2. Select **Observium.** Copy the displayed **Webhook URL** to [configure](observium.md#in-observium-create-a-squadcast-webhook) it within **Observium**. Finish by clicking **Add Alert Source** -> **Done.**

![](<../../.gitbook/assets/Observium.png>)
