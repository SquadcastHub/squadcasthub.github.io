...
2. Select **Nagios.** Copy the displayed **Webhook URL** to [configure](nagios.md#create-a-squadcast-webhook-in-nagios) it within **Nagios**. Finish by clicking **Add Alert Source** -> **Done.**

![](<../../.gitbook/assets/Nagios.png>)
