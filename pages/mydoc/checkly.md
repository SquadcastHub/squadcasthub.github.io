...
**(2)** Select **Checkly**. Copy the displayed **Webhook URL** to [configure](checkly#in-checkly-create-a-squadcast-webhook) it within **Checkly**. Finish by clicking **Add Alert Source** -> **Done**.
