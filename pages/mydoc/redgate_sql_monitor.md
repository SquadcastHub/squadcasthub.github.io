...
That's it, you are good to go! Your Redgate SQL Monitor integration is now complete. Whenever Redgate SQL Monitor fires an alert, an incident will be created in Squadcast for it. Also, when an alert is resolved in Redgate SQL Monitor, the corresponding incident gets **auto-resolved** in Squadcast.
