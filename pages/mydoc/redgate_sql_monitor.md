...
2. Select **Redgate SQL Monitor.** Copy the displayed **Webhook URL** to [configure](redgate\_sql\_monitor.md#create-a-squadcast-webhook-alert-in-redgate-sql-monitor) it within **Redgate SQL Monitor**. Finish by clicking **Add Alert Source** -> **Done.**

![](<../../.gitbook/assets/Redgate SQL Monitor.png>)
