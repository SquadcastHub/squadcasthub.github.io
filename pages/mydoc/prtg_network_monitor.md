...
2. Select **PRTG Network Monitor.** Copy the displayed **Webhook URL** to [configure](prtg\_network\_monitor.md#create-a-squadcast-webhook-in-prtg-network-monitor) it within **PRTG Network Monitor**. Finish by clicking **Add Alert Source** -> **Done.**

![](<../../.gitbook/assets/PRTG Network Monitor.png>)
