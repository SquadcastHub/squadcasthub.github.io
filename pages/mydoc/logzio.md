...
2. Select **Logz.io.** Copy the displayed **Webhook URL** to [configure](logzio.md#in-logz.io-create-a-squadcast-webhook-alert) it within **Logz.io**. Finish by clicking **Add Alert Source** -> **Done.**

![](<../../.gitbook/assets/Logz.io.png>)
