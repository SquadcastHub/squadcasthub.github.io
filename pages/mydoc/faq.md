...
You can verify your account by reaching out to our [Support Team](mailto:support@squadcast.com) and we will get in touch with you within 1 business day.
...
![](images/upgrade_1.png){: style="max-width: 20%" }
...
![](images/users_1.png){: style="max-width: 16%" }
