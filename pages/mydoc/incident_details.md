...
| Responsiveness             | []() Responsiveness shows three timelines: <br> 1. **Created** - Time elapsed since the creation of the incident <br> 2. **First Ack** - Time elapsed since first Acknowledgement of the incident <br> 3. **Resolution time** - Time elapsed since creation to resolution of the incident <br> ![](images/incidents_responsiveness.png) |
