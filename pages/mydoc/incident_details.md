...
| Responsiveness             | []() 1. **Created** - Time elapsed since the creation of the incident. <br> 2. **Latest Ack** - Time elapsed since the latest acknowledgement of the incident. It will change every time the incident is reassigned.  <br> 3. **TTA** - Time elapsed from trigger to the first acknowledgement of the incident. <br> 4. **Elapsed Time** - Time elapsed since the creation of the incident. Elapsed Time is indicated till the incident is resolved, after the resolution, it changes to TTR. <br> 5. **Resolution Time (TTR)** - Time taken from trigger to resolution. Elapsed Time changes to TTR once the incident is resolved. Even if the incident is reassigned, this value will not change. ![](images/incident_details_2.png) <br> Fig. When the incident is triggered/acknowledged. ![](images/incident_details_1.png) Fig. When the incident is resolved. |
