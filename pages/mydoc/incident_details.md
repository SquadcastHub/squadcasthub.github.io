...
| Responsiveness             | []() Responsiveness displays: <br> 1. **Created** - Time elapsed since the creation of the incident <br> 2. **Latest Ack** - Time elapsed since the latest Acknowledgement of the incident. Will change everytime the incident is reassigned. Dynamic value since it gets calculated post the latest acknowledgement and value is indicated in hours/mins/sec <br> 3. **TTA** - Time elapsed from Trigger to the first Acknowledgement of the incident. Static value indicated in hours/mins/sec. <br> 4. **Elapsed Time** - Time elapsed since creation of the incident. <br> 5. **Resolution Time (TTR)** - Time taken from Trigger to Resolution. Elapsed Time changes to TTR once the incident is resolved. Even if the incident is reassigned, it should not change this value. Static since it gets calculated post the incident resolution. It's value is indicated in hours/mins/sec ![](images/incident_details_1.png) ![](images/incident_details_2.png) |
