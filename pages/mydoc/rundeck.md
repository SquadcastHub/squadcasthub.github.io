...
2. Select **Rundeck.** Copy the displayed **Webhook URL** to [configure](rundeck.md#create-a-squadcast-webhook-notification-in-rundeck) it within **Rundeck**. Finish by clicking **Add Alert Source** -> **Done.**

![](<../../.gitbook/assets/Rundeck.png>)
