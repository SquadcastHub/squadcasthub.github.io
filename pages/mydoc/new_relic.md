...
2. Select **New Relic.** Copy the displayed **Webhook URL** to [configure](new\_relic.md#in-new-relic-add-a-squadcast-webhook) it within **New Relic**. Finish by clicking **Add Alert Source** -> **Done.**

![](<../../.gitbook/assets/New Relic.png>)
