...
2. Select **WhatsUp Gold.** Copy the displayed **Webhook URL** to [configure](progress\_whatsup\_gold.md#in-whatsup-gold-configuring-the-integration-with-squadcast) it within **WhatsUp Gold**. Finish by clicking **Add Alert Source** -> **Done.**

![](<../../.gitbook/assets/Progress Whatsup Gold.png>)
